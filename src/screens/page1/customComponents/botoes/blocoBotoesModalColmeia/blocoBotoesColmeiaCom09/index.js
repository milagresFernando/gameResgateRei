...
function BlocoBotoesColmeiaCom09(props) {
  ...
  const modalContent09 = {
    title: {
      titleContent: "Título 9 modal",
      tagTitle: "5",
      titleClassName: "",
    },
    images: {
    ...
    <Fragment>
      <Col xs="12" sm="6">
        <Title
          typeH="4"
          className=""
          content={<Fragment>Primeira Linha = 5</Fragment>}
        />

        <ColmeiaWrapper className="i5">
          <ColmeiaItem
...
export default BlocoBotoesColmeiaCom09;
