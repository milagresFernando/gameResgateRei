...
function ParallaxIlustraExemplo(props) {
  let n1ValueDesk = 6;
  let n1ValueTablet = 4;
  let n1ValueMobile = 4;
  ...
  return (
    <Fragment>
      <div className="baseSize ilustraExemplo">
        <SvgParallax
          svgName="IlustraParallaxSVGN1"
...
export default ParallaxIlustraExemplo;
