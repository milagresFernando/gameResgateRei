...
// Imagens
import PsarallaxIlustraExemplo02 from "./parallaxIlustraExemplo02";

function BlocoTextoComIlustraRight(props) {
  const textsBlock1 = [
    {
      tagElement: "h5",
  ...
  return (
    <Fragment>
      <Row className="justify-content-center relative mb-5">
        <Col className="">
          <FlexImgWithText
            rowClasses="align-items-center svgParallaxBg"
            imgSide="right"
            type="customElement"
            customElement={<PsarallaxIlustraExemplo02 />}
            colMd="5"
...
export default BlocoTextoComIlustraRight;
