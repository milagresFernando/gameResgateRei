...
function TransitionsGrow() {
  ...
  const options = {
    ...
    //ou
    // timeout: 1000,
    typeInteraction: "oneClick",
    style: { transformOrigin: "0 0 0", height: 0 }, // '"left" | "center" | "right" | length | %' '"top" | "center" | "bottom" | length | %' 'length'
    scroll: true,
  };
    ...
    <Fragment>
      <Col xs="12" className="relative">
        ...
        <Title
          typeH="4"
          className=""
          content={<Fragment>Transições Grow</Fragment>}
        />
...
export default TransitionsGrow;
