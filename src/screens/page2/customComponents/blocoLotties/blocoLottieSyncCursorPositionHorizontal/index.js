...
function BlocoLottieSyncCursorPositionHorizontal(props) {
  ...
  async function loadData() {
    const lottie1 = await Lotties.getLotties("hamsterWheelLoading");
    setLotties([lottie1]);
  }
  ...
  const textsBlock = [
    {
      ...
      content: (
        <Fragment>
          Controle a animação movendo o mouse sobre o elemento no eixo
          horizontal
        </Fragment>
      ),
    },
        ...
        <Row>
          <Col xs="12">
            <Title
              ...
              content={
                <Fragment>
                  Animação sincronizada com o curso em movimento horizontal
                </Fragment>
              }
            />
...
export default BlocoLottieSyncCursorPositionHorizontal;
