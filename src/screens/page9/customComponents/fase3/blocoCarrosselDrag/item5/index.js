...
//Imagens
import imgCarrossel from "screens/assets/images/carrosselArmaBig5.jpg";
import thumb from "screens/assets/images/carrosselArmaThumb5.jpg";
...
const descriptionBlock = [
  {
    tagElement: "p",
    className: "",
    content: <Fragment>pequena descrição do personagem fundo roxo</Fragment>,
  },
  {
    tagElement: "p",
    className: "",
...
const carrosselItem = {
  ...
  info: {
    title: {
      titleContent: "personagem fundo roxo",
      tagTitle: "5",
      titleClassName: "mb-0",
    },
