...
//Imagens
import imgCarrossel from "screens/assets/images/carrosselArmaBig3.jpg";
import thumb from "screens/assets/images/carrosselArmaThumb3.jpg";
...
const descriptionBlock = [
  {
    tagElement: "p",
    className: "",
    content: <Fragment>pequena descrição do personagem fundo azul</Fragment>,
  },
  {
    tagElement: "p",
    className: "",
...
const carrosselItem = {
  ...
  info: {
    title: {
      titleContent: "personagem fundo azul",
      tagTitle: "5",
      titleClassName: "mb-0",
    },
